...
class HCV_NUME_WAVE_Attentive_InceptionTime1(nn.Module):
    ...
    def forward(self, batch: MIMIC3Data):
        ...
        output2: Tensor = self.net_22(numei)  # B*NH,net_2.outc,1
    ...
    def forward_cam(self, batch: MIMIC3Data) -> Tuple[Tensor, Dict[str, Tensor]]:
        ret_dict = {}
...
class InceptionNetwork(nn.Module):
    def __init__(self, num_layers, ni, nf, stride=3, dropout_p=0.0):
        ...
        self.outc = 4 * nf
        module_list = [
            InceptionModule(ni if idx == 0 else self.outc, nf, ni, stride, dropout_p)
